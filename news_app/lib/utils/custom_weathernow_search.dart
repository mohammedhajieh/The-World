...
class CustomWeatherNowSearch extends StatelessWidget {
  final WeatherModel weatherDataCurrent;
  final String name;
  const CustomWeatherNowSearch(
      {Key? key, required this.weatherDataCurrent, required this.name})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 25, vertical: 5),
              child: Text(
                  Jiffy.parse(weatherDataCurrent.current.lastUpdated)
                      .yMMMMEEEEd,
                  textScaler: TextScaler.linear(
                      ResponsiveUi().textScaleFactor(context)),
        ...
        SizedBox(
          height:
              ResponsiveUi().getMediaQueryHeight(context: context, value: 10),
        ),
        Row(
          ...
          children: [
            ...
            RichText(
              ...
              text: TextSpan(
                ...
                children: [
                  TextSpan(
                      text: weatherDataCurrent.current.tempC.round().toString(),
            ...
            SizedBox(
              ...
              child: RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text: '${weatherDataCurrent.current.windKph.toString()} ',
                      style: Theme.of(context).textTheme.bodyLarge,
                    ),
                    TextSpan(
                        text: 'km/h'.tr,
        ...
        SizedBox(
          height:
              ResponsiveUi().getMediaQueryWidth(context: context, value: 15),
        ),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
          children: [
            ...
            SizedBox(
              ...
              child: RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text: weatherDataCurrent.current.feelslikeC.toString(),
                      style: Theme.of(context).textTheme.bodyLarge,
                    ),
                    TextSpan(
                        text: '°C '.tr,
